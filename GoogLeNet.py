...
def GoogLeNet():
    ...
    conv_1 = Conv2D(64, kernel_size=(7, 7), padding="same",
                    strides=2, input_shape=[227, 227, 3], activation='relu')
    ...
    inc_11 = inception_module((15, 15, 480), [192, 208, 48, 64, 96, 16])
    inc_12 = inception_module((15, 15, 512), [160, 224, 64, 64, 112, 24])
    inc_13 = inception_module((15, 15, 512), [128, 256, 64, 64, 128, 24])
    inc_14 = inception_module((15, 15, 512), [128, 288, 64, 64, 144, 32])
    inc_15 = inception_module((15, 15, 544), [256, 320, 128, 128, 160, 32])
    pool_16 = MaxPool2D(pool_size=(3, 3), strides=2, padding="same")
    inc_17 = inception_module((8, 8, 832), [256, 320, 128, 128, 160, 32])
    inc_18 = inception_module((8, 8, 832), [384, 384, 128, 128, 192, 48])
    ...
    model = Sequential([conv_1, pool_2, lrn_3, conv_4,
                        conv_5, lrn_6, pool_7, inc_8, inc_9, pool_10, inc_11, inc_12, inc_13, inc_14, inc_15, pool_16, inc_17, inc_18, pool_19, drop_20, fc_21], name="GoogLeNet")
